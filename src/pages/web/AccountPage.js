                ...
                <div className="page-path">
                    <Container>
                        <div className="breadcrumbs-inner">
                            <h1 className="path-title">Compte</h1>
                            <ul>
                ...
                <div class="container">
                    <div class="account-inner">
                        <div class="account-side-navigation">
                            ...
                            <button class="filter-btn" data-show=".orders"><i class="fal fa-shopping-cart"></i> Commande</button>
                            <button class="filter-btn" data-show=".address"><i class="fal fa-map-marker-alt"></i>
                                Address</button>
                            <button class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i> Profile
                            </button>
                            <a href="wishlist.html" class="filter-btn" data-show=".dashboard"><i
                                class="fal fa-shopping-basket"></i>
                                Favoris</a>
                            <a href="login.html" class="filter-btn" data-show=".dashboard"><i
